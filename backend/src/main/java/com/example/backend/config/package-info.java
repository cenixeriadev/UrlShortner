 ...
 * API Gateway routing, CORS policies, and load balancing.
 * <p>
 ...
 *   <li>{@link com.example.backend.config.CorsGlobalConfiguration}: Defines
 *   global
 *   Cross-Origin Resource Sharing (CORS) policies to allow requests from the
 *   frontend.</li>
 * </ul>
 *
